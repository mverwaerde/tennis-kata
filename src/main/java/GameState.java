...
public enum GameState {
    ...
    public static boolean isGameSpecialValue(int player1Point, int player2Point) {
        return Arrays.stream(GameState.values()).anyMatch(gameState -> gameState.checkCondition.test(player1Point, player2Point));
    }
}
